 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \ChinLeung\MultilingualRoutes\Macros\RequestMacros::localizedRouteIs()
         * @param mixed $patterns
         * @static 
         */ 
        public static function localizedRouteIs(...$patterns)
        {
                        return \Illuminate\Http\Request::localizedRouteIs(...$patterns);
        }
