        ...
        <div class="about-certificates">
            <div class="container mx-auto">
                <div class="head text-center">
                    <span class="block">Certificates</span>
                    <h4>Quality Certificates</h4>
                </div>

                <div
                    class="swiper-container about-certificate-slide swiper-container-initialized swiper-container-horizontal">
                    <div class="swiper-wrapper"
                         style="transform: translate3d(-1575px, 0px, 0px); transition-duration: 0ms;">
                        ...
                        <div class="swiper-slide" style="width: 295px; margin-right: 20px;">
                            <div class="about-certificate-box">
                                <div class="about-certificate-box-image">
                                    <a class="block" data-fancybox="certificates" data-caption=""
                    ...
                    <div class="about-certificate-button-prev swiper-button-disabled" tabindex="0" role="button"
                    ...
                    <div class="about-certificate-button-next" tabindex="0" role="button" aria-label="Previous slide"
                         aria-disabled="false">
