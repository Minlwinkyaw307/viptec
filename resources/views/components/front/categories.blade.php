<div class="products-filter hidden lg:block lg:w-1/3 xl:w-1/4">
    <div class="products-filter-box">
        <span class="block">{{ __("Categories") }}</span>
        <ul>
...
array_diff_assoc(request()->query(), ['category'=> 'v'])) }}&category={{ $category->translations[0]->slug }}">{{ $category->translations[0]->name }}</a>
    ...
    <div class="products-communication-box align-center">
        <a class="block" href="tel:+90 212 690 9804">
            <div class="pdc-content flex align-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="32.666" height="32.666">
                    <path
